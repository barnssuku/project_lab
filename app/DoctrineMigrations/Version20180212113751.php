 ...
 */
class Version20180212113751 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, project_topic VARCHAR(255) NOT NULL, keywords LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', except LONGTEXT NOT NULL, date_written DATE NOT NULL, content LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', department VARCHAR(220) NOT NULL, UNIQUE INDEX UNIQ_2FB3D0EE8E15D785 (project_topic), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
